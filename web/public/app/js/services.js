...
libroServices.factory('login', function ($location) {
	var username;
	var password;
	return {
		setUsername : function(srnm){
			username = srnm;
			return username;
		},
		setPassword : function(psswrd){
			password = psswrd;
			return password;
		},
...
libroServices.service('xwsse', ['base64', 'sha1',
	function (base64, sha1) {
		...
		this.calc = function (ousername,opassword) {
			...
			var digest = "X-WSSE: UsernameToken Username=\"" + userName +
				"\", PasswordDigest=\"" + passwordDigest + "\", Nonce=\"" + nonce64 +
				"\", Created=\"" + created + "\"\n";
			return digest;
		}
